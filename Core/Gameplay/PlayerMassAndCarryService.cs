...
public partial class Joueur
{
    ...
    private static float ObtenirMasseUnitaireSimpleParIdKg(int idObjet) => idObjet switch
    {
        ...
        IdObjetBolCeramiqueEtain => 0.27f,
        IdObjetBolEtainFonduChaud => 0.28f,
        IdObjetBolEtainSolidifie => 0.27f,
        IdObjetBolCeramiqueScorie => 0.26f,
